...
public class AdjPhraseSpec extends PhraseElement {
	...
	public void setHead(Object newHead) {
		...
		setAdjPhraseFeatures(getFeatureAsElement(InternalFeature.HEAD));
	}

	private void setAdjPhraseFeatures(NLGElement adjElement) {
		if (adjElement == null)
			return;
		setFeature(LexicalFeature.NONPREDICATE,
				adjElement.getFeatureAsBoolean(LexicalFeature.NONPREDICATE));
	}
