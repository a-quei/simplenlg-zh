...
public abstract class LexicalFeature {
	 ...
	 * <tr>
	 * <td><b>Used by</b></td>
	 * <td>{@link simplenlg.morphology.mandarin.MorphologyProcessor}</td>
	 * </tr>
	 * <tr>
	 * <td><b>Applies to</b></td>
	 * <td>Any lexical item.</td>
	...
	public static final String NONPREDICATE = "nonpredicate";

	/**
	 * realising a word without a de.
	 */
	public static final String NO_DE = "no_de";

	public static final String PREMODIFIER = "premodifier";
